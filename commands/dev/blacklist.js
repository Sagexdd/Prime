            ...
            return message.channel.send({
                embeds: [
                    embed
                        .setColor(client.color)
                        .setDescription(
                            `<:tick_icons:1345041197483298856> | **<@${user.id}> (${user.id})** has been added as a **Blacklist** user.`
                        )
                ]
            })
        }
            ...
            return message.channel.send({
                embeds: [
                    embed
                        .setColor(client.color)
                        .setDescription(
                            `<:tick_icons:1345041197483298856> | **<@${user.id}> (${user.id})** has been removed from a **Blacklist** user.`
                        )
                ]
            })
        }
