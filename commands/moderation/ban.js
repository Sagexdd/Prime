...
module.exports = {
    ...
    run: async (client, message, args) => {
            ...
            return message.channel.send({
                embeds: [
                    new MessageEmbed()
                        .setColor(client.color)
                        .setDescription(
                            `<:icon_cross:1345041135156072541> | I must have \`Ban Members\` permissions to use this command.`
                        )
                ]
            })
        }
        ...
        const kaalo = new MessageEmbed()
            .setDescription(`<:icon_cross:1345041135156072541>| User Not Found`)
            .setColor(client.color)
        if (user === undefined)
            ...
            return message.channel.send({
                embeds: [
                    new MessageEmbed()
                        .setColor(client.color)
                        .setDescription(
                            `<:icon_cross:1345041135156072541> | If You Ban Me Then Who Will Protect Your Server Dumb!?`
                        )
                ]
            })
            ...
            return message.channel.send({
                embeds: [
                    new MessageEmbed()
                        .setColor(client.color)
                        .setDescription(
                            `<:icon_cross:1345041135156072541> | I can't ban the owner of this server.`
                        )
                ]
            })
        ...
        if (check === true || user.banable) {
            ...
            const done = new MessageEmbed()
                .setDescription(
                    `<:tick_icons:1345041197483298856> | Successfully banned **<@${user.id}>** from the server.`
                )
                .setColor(client.color)
        ...
        if (check === false) {
            try {
                ...
                const embed = new MessageEmbed()
                    .setDescription(
                        `<:icon_cross:1345041135156072541> |  My highest role is below or same as **<@${user.id}>** `
                    )
                    .setColor(client.color)
                return message.channel.send({ embeds: [embed] })
            }
